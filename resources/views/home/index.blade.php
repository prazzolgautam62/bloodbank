...
<html lang="en">
    ...
    <div class="alert alert-success" style="margin: 0px -10px;">{{session()->get('message')}}</div>
  @elseif(session()->has('error'))
    <div class="alert alert-danger" style="margin: 0px -10px;">{{session()->get('error')}} </div>
  @endif
    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <div class="fill" style="background-image:url('{{asset('assets')}}/images/s1.jpg');"></div>
                <div class="carousel-caption">

                </div>
            </div>
            <div class="item">
                <div class="fill" style="background-image:url('{{asset('assets')}}/images/s2.jpg');"></div>
                <div class="carousel-caption">

                </div>
            </div>
            <div class="item">
                <div class="fill" style="background-image:url('{{asset('assets')}}/images/s3.jpg');"></div>
                <div class="carousel-caption">
    ...
    <div class="container">
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="{{ url('donor-registration')}}" class="btn btn-primary">View More</a>
                    </div>
                </div>
            </div>
			 <div class="col-md-4">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="{{ url('request-blood')}}" class="btn btn-primary">View More</a>
                    </div>
                </div>
            </div>
			  ...
			  <div class="col-md-4">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="{{ url('search-donor')}}" class="btn btn-primary">View More</a>
                    </div>
                </div>
            </div>
      ...
      <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
                <a href="#">
                    <img class="img-responsive img-portfolio img-thumbnail img-hover" src="{{asset('assets')}}/images/p1.jpg" alt="">
                </a>
            </div>
            <div class="col-md-4 col-sm-6">
                <a href="#">
                    <img class="img-responsive img-portfolio img-thumbnail img-hover" src="{{asset('assets')}}/images/p2.jpg" alt="">
                </a>
            </div>
            <div class="col-md-4 col-sm-6">
                <a href="#">
                    <img class="img-responsive img-portfolio img-thumbnail img-hover" src="{{asset('assets')}}/images/p3.jpg" alt="">
                </a>
            </div>
            <div class="col-md-4 col-sm-6">
                <a href="#">
                    <img class="img-responsive img-portfolio img-thumbnail img-hover" src="{{asset('assets')}}/images/p4.jpg" alt="">
                </a>
            </div>
            <div class="col-md-4 col-sm-6">
                <a href="#">
                    <img class="img-responsive img-portfolio img-thumbnail img-hover" src="{{asset('assets')}}/images/p5.jpg" alt="">
                </a>
            </div>
            <div class="col-md-4 col-sm-6">
                <a href="#">
                    <img class="img-responsive img-portfolio img-thumbnail img-hover" src="{{asset('assets')}}/images/p6.jpg" alt="">
                </a>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="well">
            <div class="row">
                ...
                <div class="col-md-4">
                    <a class="btn btn-primary btn-block" href="{{ url('contact')}}"><i class="fa fa-phone"></i> Call to Action</a>
                </div>
            </div>
        </div>
